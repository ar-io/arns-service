...
import { contractBalanceHandler, contractFieldHandler, contractHandler, contractRecordHandler, prometheusHandler, walletContractHandler, walletInteractionHandler  } from "./routes";
...
router.post(`/wallet/:address${PDNS_CONTRACT_ID_REGEX}/contracts`, walletContractHandler)
router.get(`/wallet/:address${PDNS_CONTRACT_ID_REGEX}/contract/:id${PDNS_CONTRACT_ID_REGEX}`, walletInteractionHandler)
